...
namespace BLEWindowsConsole.src.Services.GattUuidsService
{
    public static class GattUuidsService
    {
        ...
        public static ushort ConvertUuidToShortId(Guid uuid)
        {
            ...
            var shortUuid = (ushort)(bytes[0] | (bytes[1] << 8));       //TODO:???
            return shortUuid;
        }
    }

    //The enum assists in finding a string representation of a BT SIG assigned value for UUIDs
